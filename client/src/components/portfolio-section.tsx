const portfolioItems = [
  {
    ...
    title: "Tienda Online",
    description:
      "Diseño y desarrollo, experiencia de usuario optimizada incluyendo logo, paleta de colores y manual de marca."
  },
  {
    image: "https://i.postimg.cc/T3Fgkz4Q/mockups-nro2.jpg",
    title: "Identidad única",
    description:
      "Desarrollo completo de identidad visual para proyecto huerta comunitaria, y experiencia de usuario optimizada."
  },
  {
      ...
      <div className="container">
        <div className="text-center">
          ...
          <p className="section-subtitle" data-testid="portfolio-subtitle">
            Descubre algunos de nuestros proyectos más destacados y el impacto
            que hemos generado
          </p>
        </div>
              ...
              <div className="portfolio-overlay">
                <div className="portfolio-overlay-content">
                  <h3
                    ...
                    data-testid={`portfolio-overlay-title-${index}`}
                  >
                    {item.title}
                  </h3>
                  <p
                    className="portfolio-overlay-description"
                    data-testid={`portfolio-overlay-description-${index}`}
                  >
                    {item.description}
                  </p>
                </div>
